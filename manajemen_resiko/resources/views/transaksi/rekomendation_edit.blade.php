...
<div class="container mt-5">
    <h2 class="text-center mb-4">Form Edit Recommendation</h2>
    <div class="row ">
        <div class="col-8"></div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form method="post" action="{{route('recommendation.update', $recommendation->id)}}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tanggal_rekomendasi" class="form-control" value="{{ old('tanggal_rekomendasi', optional($recommendation)->tanggal_rekomendasi) }}">
                    
                </div>
                <div class="form-group mb-3">
                    <label for="deskripsi_rekomendasi">Deskripsi Rekomendasi:</label>
                    <input type="text" class="form-control" id="deskripsi_rekomendasii" name="deskripsi_rekomendasi" value="{{$recommendation->deskripsi_rekomendasi}}" placeholder="Masukkan Deskripsi Rekomendasi">
                </div>
